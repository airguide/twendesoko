 ...
 * Initializes a new instance of the PartitionHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function PartitionHealthReports(client) {
  this.client = client;
}
 ...
 */
PartitionHealthReports.prototype.send = function (partitionId, partitionHealthReport, options, callback) {
...
module.exports = PartitionHealthReports;
