 ...
 * Initializes a new instance of the DeployedServicePackageHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function DeployedServicePackageHealthReports(client) {
  this.client = client;
}
 ...
 */
DeployedServicePackageHealthReports.prototype.send = function (nodeName, applicationName, serviceManifestName, deployedServicePackageHealthReport, options, callback) {
...
module.exports = DeployedServicePackageHealthReports;
