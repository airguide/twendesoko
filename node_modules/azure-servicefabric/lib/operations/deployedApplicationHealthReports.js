 ...
 * Initializes a new instance of the DeployedApplicationHealthReports class.
 * @constructor
 *
 * @param {ServiceFabricClient} client Reference to the service client.
 */
function DeployedApplicationHealthReports(client) {
  this.client = client;
}
 ...
 */
DeployedApplicationHealthReports.prototype.send = function (nodeName, applicationName, deployedApplicationHealthReport, options, callback) {
...
module.exports = DeployedApplicationHealthReports;
