...
var ExecutionProcessor = function(cli) {
  ...
  this.createCluster = function createCluster__1(resourceGroupName, clusterName, createParams, options, _) { var hdInsight, result, __this = this; var __frame = { name: "createCluster__1", line: 143 }; return __func(_, this, arguments, createCluster__1, 4, __frame, function __$createCluster__1() {
  ...
  this.getCluster = function getCluster__2(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "getCluster__2", line: 149 }; return __func(_, this, arguments, getCluster__2, 3, __frame, function __$getCluster__2() {
  ...
  this.deleteCluster = function deleteCluster__3(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "deleteCluster__3", line: 155 }; return __func(_, this, arguments, deleteCluster__3, 3, __frame, function __$deleteCluster__3() {
      hdInsight = self.createHdiClient(cli, options.subscription);
      return hdInsight.deleteCluster(resourceGroupName, clusterName, __cb(_, __frame, 2, 27, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.listClusters = function listClusters__4(resourceGroupName, options, _) { var hdInsight, result; var __frame = { name: "listClusters__4", line: 161 }; return __func(_, this, arguments, listClusters__4, 2, __frame, function __$listClusters__4() {
      hdInsight = self.createHdiClient(cli, options.subscription);
      return hdInsight.listClusters(resourceGroupName, __cb(_, __frame, 2, 27, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.resizeCluster = function resizeCluster__5(resourceGroupName, clusterName, targetInstanceCount, options, _) { var hdInsight, result; var __frame = { name: "resizeCluster__5", line: 167 }; return __func(_, this, arguments, resizeCluster__5, 4, __frame, function __$resizeCluster__5() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.listPersistedScripts = function listPersistedScripts__6(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "listPersistedScripts__6", line: 173 }; return __func(_, this, arguments, listPersistedScripts__6, 3, __frame, function __$listPersistedScripts__6() {
      hdInsight = self.createHdiClient(cli, options.subscription);
      return hdInsight.listPersistedScripts(resourceGroupName, clusterName, __cb(_, __frame, 2, 27, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.listScriptExecutionHistory = function listScriptExecutionHistory__7(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "listScriptExecutionHistory__7", line: 179 }; return __func(_, this, arguments, listScriptExecutionHistory__7, 3, __frame, function __$listScriptExecutionHistory__7() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.getScriptExecutionDetail = function getScriptExecutionDetail__8(resourceGroupName, clusterName, scriptExecutionId, options, _) { var hdInsight, result; var __frame = { name: "getScriptExecutionDetail__8", line: 185 }; return __func(_, this, arguments, getScriptExecutionDetail__8, 4, __frame, function __$getScriptExecutionDetail__8() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.promoteScript = function promoteScript__9(resourceGroupName, clusterName, scriptExecutionId, options, _) { var hdInsight, result; var __frame = { name: "promoteScript__9", line: 191 }; return __func(_, this, arguments, promoteScript__9, 4, __frame, function __$promoteScript__9() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.deletePersistedScript = function deletePersistedScript__10(resourceGroupName, clusterName, name, options, _) { var hdInsight, result; var __frame = { name: "deletePersistedScript__10", line: 197 }; return __func(_, this, arguments, deletePersistedScript__10, 4, __frame, function __$deletePersistedScript__10() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.executeScriptActions = function executeScriptActions__11(resourceGroupName, clusterName, executeScriptActionParameters, options, _) { var hdInsight, result; var __frame = { name: "executeScriptActions__11", line: 203 }; return __func(_, this, arguments, executeScriptActions__11, 4, __frame, function __$executeScriptActions__11() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.enableHttp = function enableHttp__12(resourceGroupName, clusterName, userName, password, options, _) { var hdInsight, result; var __frame = { name: "enableHttp__12", line: 209 }; return __func(_, this, arguments, enableHttp__12, 5, __frame, function __$enableHttp__12() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.disableHttp = function disableHttp__13(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "disableHttp__13", line: 215 }; return __func(_, this, arguments, disableHttp__13, 3, __frame, function __$disableHttp__13() {
      hdInsight = self.createHdiClient(cli, options.subscription);
      return hdInsight.disableHttp(resourceGroupName, clusterName, __cb(_, __frame, 2, 27, function ___(__0, __1) { result = __1;
        return _(null, result); }, true)); }); };


  this.enableRdp = function enableRdp__14(resourceGroupName, clusterName, rdpUserName, rdpPassword, rdpExpiryDate, options, _) { var hdInsight, result; var __frame = { name: "enableRdp__14", line: 221 }; return __func(_, this, arguments, enableRdp__14, 6, __frame, function __$enableRdp__14() {
      hdInsight = self.createHdiClient(cli, options.subscription);
  ...
  this.disableRdp = function disableRdp__15(resourceGroupName, clusterName, options, _) { var hdInsight, result; var __frame = { name: "disableRdp__15", line: 227 }; return __func(_, this, arguments, disableRdp__15, 3, __frame, function __$disableRdp__15() {
      hdInsight = self.createHdiClient(cli, options.subscription);
...
var hdInsightCommandLine = function(cli, userInteractor, executionProcessor) {
  ...
  this.createClusterCommand = function createClusterCommand__1(clusterName, options, _) { var additionalStorageAccountsList, configurationsFileContent, clusterCreateParameters, result; var __frame = { name: "createClusterCommand__1", line: 268 }; return __func(_, this, arguments, createClusterCommand__1, 2, __frame, function __$createClusterCommand__1() {
                    ...
                    return self.user.promptIfNotGiven($("Number of worker nodes: "), options.workerNodeCount, __cb(_, __frame, 9, 40, function ___(__0, __8) { options.workerNodeCount = __8;
                      return self.user.promptIfNotGiven($("User name: "), options.userName, __cb(_, __frame, 10, 33, function ___(__0, __9) { options.userName = __9;
                        return self.user.promptIfNotGiven($("Password: "), options.password, __cb(_, __frame, 11, 33, function ___(__0, __10) { options.password = __10;
                          return self.user.promptIfNotGiven($("Cluster Type: "), options.clusterType, __cb(_, __frame, 12, 36, function ___(__0, __11) { options.clusterType = __11;
                            ...
                            if (utils.stringIsNullOrEmpty(options.version)) {
                              ...
                              if (utils.ignoreCaseEquals(options.osType, "windows")) {
                                return self.user.promptIfNotGiven($("Head node size (string): "), options.headNodeSize, __cb(_, __frame, 24, 39, function ___(__0, __12) { options.headNodeSize = __12;
                                  return self.user.promptIfNotGiven($("Data node size (string): "), options.workerNodeSize, __cb(_, __frame, 25, 41, function ___(__0, __13) { options.workerNodeSize = __13; __then(); }, true)); }, true)); } else { return (function __$createClusterCommand__1(__then) {

                                  if (utils.ignoreCaseEquals(options.osType, "linux")) {
                                    return self.user.promptIfNotGiven($("SSH user name: "), options.sshUserName, __cb(_, __frame, 28, 38, function ___(__0, __14) { options.sshUserName = __14;
                                      return self.user.promptIfNotGiven($("SSH password: "), options.sshPassword, __cb(_, __frame, 29, 38, function ___(__0, __15) { options.sshPassword = __15; __then(); }, true)); }, true)); } else { __then(); } ; })(__then); } ; })(function __$createClusterCommand__1() {
                              ...
                              if (!utils.stringIsNullOrEmpty(options.additionalStorageAccounts)) {
                                ...
                                if ((((!utils.stringIsNullOrEmpty(options.hiveMetastoreServerName) || !utils.stringIsNullOrEmpty(options.hiveMetastoreDatabaseName)) || !utils.stringIsNullOrEmpty(options.hiveMetastoreUserName)) || !utils.stringIsNullOrEmpty(options.hiveMetastorePassword))) {
                                  return self.user.promptIfNotGiven($("Hive metastore Server name: "), options.hiveMetastoreServerName, __cb(_, __frame, 46, 50, function ___(__0, __16) { options.hiveMetastoreServerName = __16;
                                    return self.user.promptIfNotGiven($("Hive metastore database name: "), options.hiveMetastoreDatabaseName, __cb(_, __frame, 47, 52, function ___(__0, __17) { options.hiveMetastoreDatabaseName = __17;
                                      return self.user.promptIfNotGiven($("Hive metastore database username: "), options.hiveMetastoreUserName, __cb(_, __frame, 48, 48, function ___(__0, __18) { options.hiveMetastoreUserName = __18;
                                        return self.user.promptIfNotGiven($("Hive metastore database password: "), options.hiveMetastorePassword, __cb(_, __frame, 49, 48, function ___(__0, __19) { options.hiveMetastorePassword = __19;
                                  ...
                                  if ((((!utils.stringIsNullOrEmpty(options.oozieMetastoreServerName) || !utils.stringIsNullOrEmpty(options.oozieMetastoreDatabaseName)) || !utils.stringIsNullOrEmpty(options.oozieMetastoreUserName)) || !utils.stringIsNullOrEmpty(options.oozieMetastorePassword))) {
                                    return self.user.promptIfNotGiven($("Oozie metastore Server name: "), options.oozieMetastoreServerName, __cb(_, __frame, 60, 51, function ___(__0, __20) { options.oozieMetastoreServerName = __20;
                                      return self.user.promptIfNotGiven($("Oozie metastore database name: "), options.oozieMetastoreDatabaseName, __cb(_, __frame, 61, 53, function ___(__0, __21) { options.oozieMetastoreDatabaseName = __21;
                                        return self.user.promptIfNotGiven($("Oozie metastore database username: "), options.oozieMetastoreUserName, __cb(_, __frame, 62, 49, function ___(__0, __22) { options.oozieMetastoreUserName = __22;
                                          return self.user.promptIfNotGiven($("Oozie metastore database password: "), options.oozieMetastorePassword, __cb(_, __frame, 63, 49, function ___(__0, __23) { options.oozieMetastorePassword = __23;
                                    ...
                                    if ((((((!utils.stringIsNullOrEmpty(options.domain) || !utils.stringIsNullOrEmpty(options.organizationalUnitDN)) || !utils.stringIsNullOrEmpty(options.ldapsUrls)) || !utils.stringIsNullOrEmpty(options.domainUsername)) || !utils.stringIsNullOrEmpty(options.domainUserPassword)) || !utils.stringIsNullOrEmpty(options.clusterUsersGroupDNs))) {
                                      ...
                                      return self.user.promptIfNotGiven($("Security Profile - domain: "), options.domain, __cb(_, __frame, 80, 37, function ___(__0, __24) { options.domain = __24;
                                        return self.user.promptIfNotGiven($("Security Profile - organization unit DN: "), options.organizationalUnitDN, __cb(_, __frame, 81, 51, function ___(__0, __25) { options.organizationalUnitDN = __25;
                                          return self.user.promptIfNotGiven($("Security Profile - ldaps urls (comma separated): "), options.ldapsUrls, __cb(_, __frame, 82, 40, function ___(__0, __26) { options.ldapsUrls = __26;
                                            return self.user.promptIfNotGiven($("Security Profile - domain username: "), options.domainUsername, __cb(_, __frame, 83, 45, function ___(__0, __27) { options.domainUsername = __27;
                                              return self.user.promptIfNotGiven($("Security Profile - domain password: "), options.domainUserPassword, __cb(_, __frame, 84, 49, function ___(__0, __28) { options.domainUserPassword = __28;
                                    ...
                                    return self.processor.createCluster(options.resourceGroup, clusterName, clusterCreateParameters, options, __cb(_, __frame, 139, 32, function ___(__0, __29) { result = __29;
                                      ...
                                      if (self.log.format().json) {
                                        ...
                                        if (((result !== null) && (result !== undefined))) {
                                          ...
                                          self.log.data($("Cluster creation response is empty.")); } ; } ; _(); }, true)); }); }); }); }); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); };




  this.showClusterCommand = function showClusterCommand__2(clusterName, options, _) { var result, cluster, clusterInfo; var __frame = { name: "showClusterCommand__2", line: 423 }; return __func(_, this, arguments, showClusterCommand__2, 2, __frame, function __$showClusterCommand__2() {
  ...
  this.listClustersCommand = function listClustersCommand__3(options, _) { var result, clusters; var __frame = { name: "listClustersCommand__3", line: 454 }; return __func(_, this, arguments, listClustersCommand__3, 1, __frame, function __$listClustersCommand__3() {
  ...
  this.deleteClusterCommand = function deleteClusterCommand__4(clusterName, options, _) { var __frame = { name: "deleteClusterCommand__4", line: 498 }; return __func(_, this, arguments, deleteClusterCommand__4, 2, __frame, function __$deleteClusterCommand__4() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.resizeClusterCommand = function resizeClusterCommand__5(clusterName, targetInstanceCount, options, _) { var result; var __frame = { name: "resizeClusterCommand__5", line: 509 }; return __func(_, this, arguments, resizeClusterCommand__5, 3, __frame, function __$resizeClusterCommand__5() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.listPersistedScriptsCommand = function listPersistedScriptsCommand__6(clusterName, options, _) { var result; var __frame = { name: "listPersistedScriptsCommand__6", line: 522 }; return __func(_, this, arguments, listPersistedScriptsCommand__6, 2, __frame, function __$listPersistedScriptsCommand__6() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.showPersistedScriptsCommand = function showPersistedScriptsCommand__7(clusterName, name, options, _) { var result, filteredScripts, item; var __frame = { name: "showPersistedScriptsCommand__7", line: 553 }; return __func(_, this, arguments, showPersistedScriptsCommand__7, 3, __frame, function __$showPersistedScriptsCommand__7() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
  ...
  this.promoteScriptCommand = function promoteScriptCommand__8(clusterName, scriptExecutionId, options, _) { var __frame = { name: "promoteScriptCommand__8", line: 586 }; return __func(_, this, arguments, promoteScriptCommand__8, 3, __frame, function __$promoteScriptCommand__8() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
  ...
  this.deletePersistedScriptCommand = function deletePersistedScriptCommand__9(clusterName, name, options, _) { var __frame = { name: "deletePersistedScriptCommand__9", line: 596 }; return __func(_, this, arguments, deletePersistedScriptCommand__9, 3, __frame, function __$deletePersistedScriptCommand__9() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Script name: "), name, __cb(_, __frame, 2, 21, function ___(__0, __2) { name = __2;
          return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 3, 28, function ___(__0, __3) { clusterName = __3;
  ...
  this.listScriptExecutionHistoryCommand = function listScriptExecutionHistoryCommand__10(clusterName, options, _) { var result; var __frame = { name: "listScriptExecutionHistoryCommand__10", line: 606 }; return __func(_, this, arguments, listScriptExecutionHistoryCommand__10, 2, __frame, function __$listScriptExecutionHistoryCommand__10() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.enableHttpAccessCommand = function enableHttpAccessCommand__13(clusterName, userName, password, options, _) { var result; var __frame = { name: "enableHttpAccessCommand__13", line: 710 }; return __func(_, this, arguments, enableHttpAccessCommand__13, 4, __frame, function __$enableHttpAccessCommand__13() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.disableHttpAccessCommand = function disableHttpAccessCommand__14(clusterName, options, _) { var result; var __frame = { name: "disableHttpAccessCommand__14", line: 726 }; return __func(_, this, arguments, disableHttpAccessCommand__14, 2, __frame, function __$disableHttpAccessCommand__14() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.enableRdpAccessCommand = function enableRdpAccessCommand__15(clusterName, rdpUserName, rdpPassword, rdpExpiryDate, options, _) { var rdpAccessExpiryDate, parsedExpiryDate, result; var __frame = { name: "enableRdpAccessCommand__15", line: 740 }; return __func(_, this, arguments, enableRdpAccessCommand__15, 5, __frame, function __$enableRdpAccessCommand__15() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.disableRdpAccessCommand = function disableRdpAccessCommand__16(clusterName, options, _) { var result; var __frame = { name: "disableRdpAccessCommand__16", line: 763 }; return __func(_, this, arguments, disableRdpAccessCommand__16, 2, __frame, function __$disableRdpAccessCommand__16() {
      return self.user.promptIfNotGiven($("Resource Group name: "), options.resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { options.resourceGroup = __1;
        return self.user.promptIfNotGiven($("Cluster name: "), clusterName, __cb(_, __frame, 2, 28, function ___(__0, __2) { clusterName = __2;
  ...
  this.createClusterConfigCommand = function createClusterConfigCommand__17(configFilePath, options, _) { var __frame = { name: "createClusterConfigCommand__17", line: 776 }; return __func(_, this, arguments, createClusterConfigCommand__17, 2, __frame, function __$createClusterConfigCommand__17() {
  ...
  this.addConfigValue = function addConfigValue__18(configFilePath, options, _) { var __frame = { name: "addConfigValue__18", line: 791 }; return __func(_, this, arguments, addConfigValue__18, 2, __frame, function __$addConfigValue__18() {
      return self.user.promptIfNotGiven($("Config file path: "), configFilePath, __cb(_, __frame, 1, 31, function ___(__0, __1) { configFilePath = __1;
  ...
  this.addScriptAction = function addScriptAction__19(configFilePath, options, _) { var __frame = { name: "addScriptAction__19", line: 803 }; return __func(_, this, arguments, addScriptAction__19, 2, __frame, function __$addScriptAction__19() {
      return self.user.promptIfNotGiven($("Config file path: "), configFilePath, __cb(_, __frame, 1, 31, function ___(__0, __1) { configFilePath = __1;
...
hdInsightCommandLine.init = function(cli) {
  ...
  cluster.command("list").description($("List all the clusters (in a specific resource group if provided) .")).usage("[options]").option("-g --resource-group <resource-group>", $("The name of the resource group")).option("-s, --subscription <id>", $("The subscription id")).execute(function __4(options, _) { var __frame = { name: "__4", line: 909 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
  ...
  cluster.command("disable-http-access [clusterName]").description($("Disable HTTP access for cluster")).usage("[options] <clusterName>").option("-g --resource-group <resource-group>", $("The name of the resource group")).option("-c, --clusterName <clusterName>", $("HDInsight cluster name")).option("-s, --subscription <id>", $("The subscription id")).execute(function __7(clusterName, options, _) { var __frame = { name: "__7", line: 942 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
  ...
  cluster.command("disable-rdp-access [clusterName]").description($("Disable HTTP access for cluster")).usage("[options] <clusterName>").option("-g --resource-group <resource-group>", $("The name of the resource group")).option("-c, --clusterName <clusterName>", $("HDInsight cluster name")).option("-s, --subscription <id>", $("The subscription id")).execute(function __9(clusterName, options, _) { var __frame = { name: "__9", line: 965 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  persistedScriptAction.command("list [clusterName]").description($("Lists all persisted script actions")).usage("[options] <clusterName>").option("-g, --resource-group <resource-group>", $("The name of the resource group")).option("-c, --clusterName <clusterName>", $("HDInsight cluster name")).option("-s, --subscription <id>", $("The subscription id")).execute(function __10(clusterName, options, _) { var __frame = { name: "__10", line: 984 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
  ...
  config.command("create [configFilePath]").description($("Creates a persisted Azure HDInsight cluster configuration file.")).usage("[options] <configFilePath> <overwrite>").option("--configFilePath <configFilePath>", $("HdInsight configuration file path")).option("--overwrite <overwrite>", $("Overwrites existing configuration file")).execute(function __17(configFilePath, options, _) { var __frame = { name: "__17", line: 1066 }; return __func(_, this, arguments, __17, 2, __frame, function __$__17() {
