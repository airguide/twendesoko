...
function getTheMissingParameters(cli, deploymentParameters, missing, subscription, options, _) { var log, paramsRequired; var __frame = { name: "getTheMissingParameters", line: 483 }; return __func(_, this, arguments, getTheMissingParameters, 5, __frame, function __$getTheMissingParameters() {
    log = cli.output;
    ...
    return getTemplateParams(cli, missing, subscription, options, __cb(_, __frame, 3, 25, function ___(__0, __2) { paramsRequired = __2;
      ...
      return Object.keys(paramsRequired).forEach_(__cb(_, __frame, 6, 32, function __$getTheMissingParameters() {
        ...
        return _(null, deploymentParameters); }, true), 1, function __1(_, key) { var val; var __frame = { name: "__1", line: 489 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() { val = { }; val["value"] = paramsRequired[key]; deploymentParameters[key] = val; _(); }); }); }, true)); });};


function addMissingParameters(missingObj, deploymentParameters, cli, subscription, options, _) { var newParameters; var __frame = { name: "addMissingParameters", line: 497 }; return __func(_, this, arguments, addMissingParameters, 5, __frame, function __$addMissingParameters() { return (function __$addMissingParameters(__then) {
...
function getFailedNestedOperations(client, resourceGroup, currentOperations, _) { var newOperations; var __frame = { name: "getFailedNestedOperations", line: 513 }; return __func(_, this, arguments, getFailedNestedOperations, 3, __frame, function __$getFailedNestedOperations() {
    newOperations = [];
