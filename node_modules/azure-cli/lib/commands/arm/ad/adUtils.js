...
exports.getObjectsByObjectIds = function exports_getObjectsByObjectIds__7(graphClient, objectIds, throwOnError, _) { var objects; var __frame = { name: "exports_getObjectsByObjectIds__7", line: 238 }; return __func(_, this, arguments, exports_getObjectsByObjectIds__7, 3, __frame, function __$exports_getObjectsByObjectIds__7() {
    objects = [];
    if (((!objectIds || !objectIds.length) || (objectIds.length === 0))) {
      return _(null, objects); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_getObjectsByObjectIds__7() {
          ...
          return graphClient.objects.getObjectsByObjectIds({ objectIds: objectIds, includeDirectoryObjectReferences: true }, __cb(_, __frame, 7, 34, function ___(__0, __1) { objects = __1; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$exports_getObjectsByObjectIds__7() { if (ex) {
...
exports.listGraphObjects = function exports_listGraphObjects__8(client, objectType, interaction, log, isJsonMode, _) { var operationsSuffix, response, nextLink, response2;
  function displayObjects(objects) {
    ...
    if (utils.ignoreCaseEquals(objectType, "user")) {
      ...
      exports.displayServicePrincipals(objects, interaction, log); }   ; }; var __frame = { name: "exports_listGraphObjects__8", line: 277 }; return __func(_, this, arguments, exports_listGraphObjects__8, 5, __frame, function __$exports_listGraphObjects__8() {
...
exports.listGroupMembers = function exports_listGroupMembers__9(client, groupId, interaction, log, isJsonMode, _) { var groupMembers, nextLink, groupMembers2; var __frame = { name: "exports_listGroupMembers__9", line: 312 }; return __func(_, this, arguments, exports_listGroupMembers__9, 5, __frame, function __$exports_listGroupMembers__9() {
