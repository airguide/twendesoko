...
exports.init = function(cli) {
  ...
  config.command("set [resource-group] [name]").description($("Set webapp configuration\nexample:  webapp config set RGName WebAppName --alwayson true --numberofworkers 1")).usage("[options] <resource-group> <name>").option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the webapp to update")).option("-j --jsonInput <jsonInput>", $("the json config object string")).option("--phpversion <phpversion>", $("php version of webapp")).option("--pythonversion <pythonversion>", $("python version of webapp")).option("--nodeversion <nodeversion>", $("node version of webapp")).option("--numberofworkers <numberofworkers>", $("number of workers")).option("--appcommandline <appcommandline>", $("app command line")).option("--netframeworkversion <netframeworkversion>", $("net framwork version of webapp")).option("--requesttracingenabled <requesttracingenabled>", $("request tracing enabled option")).option("--remotedebuggingenabled <remotedebuggingenabled>", $("remote debugging enabled option")).option("--httploggingenabled <httploggingenabled>", $("http logging enabled option")).option("--detailederrorloggingenabled <detailederrorloggingenabled>", $("detailed error logging enabled option")).option("--websocketenabled <websocketenabled>", $("web socket enabled option")).option("--use32bitworkerprocess <use32bitworkerprocess>", $("use 32 bit process option")).option("--alwayson <alwayson>", $("always on option")).option("--autohealenabled <autohealenabled>", $("auto heal enabled option")).option("--javaversion <javaversion>", $("java version of webapp")).option("--javacontainer <javacontainer>", $("java container of webapp")).option("--javacontainerversion <javacontainerversion>", $("java container version of webapp")).option("--slot <slot>", $("the name of the slot")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var webSiteSlotName, subscription, client, progress, jsonObj, result; var __frame = { name: "__2", line: 165 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      ...
      if (((options.javacontainerversion !== null) && (options.javacontainerversion !== undefined))) {
        jsonObj["javaContainerVersion"] = options.javacontainerversion; } ; return (function __$__2(__then) {
        ...
        if ((Object.keys(jsonObj).length !== 0)) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function __$__2(__then) {
                  ...
                  if (options.slot) {
                    return client.sites.getSiteSlot(resourceGroup, name, options.slot, __cb(_, __frame, 79, 34, function ___(__0, __1) { result = __1;
                      jsonObj["location"] = result.location;
                      return client.sites.createOrUpdateSiteConfigSlot(resourceGroup, name, jsonObj, options.slot, __cb(_, __frame, 81, 34, function ___(__0, __2) { result = __2;
                        log.info((((("Webapp slot " + name) + "/") + options.slot) + " configuration has been updated ")); __then(); }, true)); }, true)); } else {


                    return client.sites.getSite(resourceGroup, name, __cb(_, __frame, 85, 34, function ___(__0, __3) { result = __3;
                      jsonObj["location"] = result.location;
                      return client.sites.createOrUpdateSiteConfig(resourceGroup, name, jsonObj, __cb(_, __frame, 87, 34, function ___(__0, __4) { result = __4;
  ...
  appsettings.command("set [resource-group] [name] [appsettings]").description($("Set webapp app settings (using comma seperated key value pairs)\nexample:  webapp config appsettings set RGName WebAppName KEY1=val1,KEY2=val2,KEY3=val3")).usage("[options] <resource-group> <name> <appsettings>").option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the webapp to show")).option("-a --appsettings <appsettings>", $("the appsettings of the webapp to add")).option("--slot <slot>", $("the name of the slot")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, name, appsettings, options, _) { var subscription, client, progress, currentAppSettings, appSettingsToAdd, appSettingsToAddSplit, settingSplit, result, i, firstEqual; var __frame = { name: "__3", line: 287 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
  ...
  appsettings.command("delete [resource-group] [name] [appsettings]").description($("Delete webapp app settings (using comma seperated keys)\nexample:  webapp config appsettings delete RGName WebAppName KEY1,KEY2,KEY3")).usage("[options] <resource-group> <name> <appsettings>").option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the webapp to show")).option("-a --appsettings <appsettings>", $("the appsettings of the webapp to delete")).option("--slot <slot>", $("the name of the slot")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, appsettings, options, _) { var subscription, client, progress, currentAppSettings, appSettingsToDelete, appSettingsToDeleteSplit, result, appSettingsToDeleteProperties, i, attrname; var __frame = { name: "__4", line: 350 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
      ...
      progress = cli.interaction.progress($("Getting webapp hostnames")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__9() { return (function __$__9(__then) {
          ...
          cli.interaction.formatOutput(result, function(data) {
            ...
            if ((data.length > 0)) {
              ...
              log.info($("No web app hostname bindings found.")); } ; }); _(); }); }); }); });




  container.command("set [resource-group] [name]").description($("Set webapp Container configurations (available only for linux webapps)")).usage("[options] <resource-group> <name>").option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the webapp")).option("-r --url <url>", $("the container registry server url")).option("-u --username <username>", $("the container registry server username")).option("-p --password <password>", $("the container registry server password")).option("-c --custom-image-name <custom-image-name>", $("the container custom image name and optionally the tag name")).option("--slot <slot>", $("the name of the slot")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __10(resourceGroup, name, options, _) { var subscription, client, progress, currentAppSettings, result; var __frame = { name: "__10", line: 622 }; return __func(_, this, arguments, __10, 3, __frame, function __$__10() {
  ...
  container.command("delete [resource-group] [name]").description($("Delete all webapp Container configurations (available only for linux webapps)")).usage("[options] <resource-group> <name>").option("-g --resource-group <resource-group>", $("the name of the resource group")).option("-n --name <name>", $("the name of the webapp")).option("--slot <slot>", $("the name of the slot")).option("-s --subscription <subscription>", $("the subscription identifier")).execute(function __12(resourceGroup, name, options, _) { var subscription, client, progress, currentAppSettings; var __frame = { name: "__12", line: 714 }; return __func(_, this, arguments, __12, 3, __frame, function __$__12() {
