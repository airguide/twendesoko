...
__.extend(Nsg.prototype, {
  ...
  _parseSecurityRule: function(rule, options, useDefaults) {
    ...
    if (options.protocol) {
      ...
      rule.protocol = utils.takeDefault(self.output, constants.nsg.protocols[0], "--protocol"); }  ;
    ...
    if (options.destinationPortRange) {
      ...
      rule.destinationPortRange = utils.takeDefault(self.output, constants.nsg.portDef, "--destination-port-range"); }  ;
  ...
  _isAddressPrefix: function(prefix, paramName) {
    ...
    try {
      ...
      try {
        ...
        throw new Error(util.format($("%s must be in CIDR format. \"%s\" can be used also."), paramName, constants.nsg.prefix)); }; }; },
