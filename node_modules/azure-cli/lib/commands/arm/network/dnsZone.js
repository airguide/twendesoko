...
__.extend(DnsZone.prototype, {
  ...
  clear: function clear__5(resourceGroupName, zoneName, options, _) { var self, recordSets, progress, i, recordSet, type, __this = this; var __frame = { name: "clear__5", line: 134 }; return __func(_, this, arguments, clear__5, 3, __frame, function __$clear__5() { self = __this;
      ...
      zoneName = utils.trimTrailingChar(zoneName, "."); return (function __$clear__5(_) {
        ...
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Clear dns zone \"%s\"? [y/n] "), zoneName), __cb(_, __frame, 4, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -133, 17, function ___(__0, __2) { return (function __$clear__5(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$clear__5() {
          ...
          progress = self.interaction.progress($("Looking up the DNS Record Sets")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$clear__5() {
                ...
                return self.dnsManagementClient.recordSets.listAllInResourceGroup(resourceGroupName, zoneName, options, __cb(_, __frame, 11, 55, function ___(__0, __3) { recordSets = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$clear__5() {
              ...
              i = 0; var __7 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$clear__5() { __more = false; if (__7) { i++; } else { __7 = true; } ; var __6 = (i < recordSets.length); if (__6) {
                    ...
                    options.type = type;
                    return self.deleteRecordSet(resourceGroupName, zoneName, recordSet.name, options, __cb(_, __frame, 22, 11, function __$clear__5() { while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(_); }); }); }); }, true)); }); },



  delete: function delete__6(resourceGroupName, zoneName, options, _) { var self, progress, response, __this = this; var __frame = { name: "delete__6", line: 160 }; return __func(_, this, arguments, delete__6, 3, __frame, function __$delete__6() { self = __this;

      zoneName = utils.trimTrailingChar(zoneName, ".");

      self.output.warn(util.format($("Deleting dns zone \"%s\" you will delete all record sets"), zoneName)); return (function __$delete__6(_) {
        var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($(("WARNING: This will delete the DNS zone \"%s\" and all DNS records. " + "This operation cannot be undone. Please confirm [y/n]")), zoneName), __cb(_, __frame, 5, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -159, 17, function ___(__0, __2) { return (function __$delete__6(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$delete__6() {
          ...
          progress = self.interaction.progress(util.format($("Deleting dns zone \"%s\""), zoneName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$delete__6() {
                ...
                return self.dnsManagementClient.zones.deleteMethod(resourceGroupName, zoneName, options, __cb(_, __frame, 13, 48, function ___(__0, __3) { response = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$delete__6() {
  ...
  get: function get__7(resourceGroupName, zoneName, _) { var self, progress, dnsZone, __this = this; var __frame = { name: "get__7", line: 183 }; return __func(_, this, arguments, get__7, 2, __frame, function __$get__7() { self = __this;
  ...
  update: function update__8(resourceGroupName, zoneName, dnsZone, _) { var self, progress, __this = this; var __frame = { name: "update__8", line: 200 }; return __func(_, this, arguments, update__8, 3, __frame, function __$update__8() { self = __this;
  ...
  import: function import__9(resourceGroupName, zoneName, options, _) { var self, text, zfile, dnsZone, totalSetsCount, importedSetsCount, i, recordSet, __this = this; var __frame = { name: "import__9", line: 213 }; return __func(_, this, arguments, import__9, 3, __frame, function __$import__9() { self = __this;
      ...
      return self.get(resourceGroupName, zoneName, __cb(_, __frame, 14, 23, function ___(__0, __1) { dnsZone = __1; return (function __$import__9(__then) {
          ...
          i = 0; var __6 = false; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$import__9() { __more = false; if (__6) { i++; } else { __6 = true; } ; var __5 = (i < zfile.sets.length); if (__5) {
                ...
                return self.importRecordSet(resourceGroupName, zoneName, recordSet, options, __cb(_, __frame, 24, 32, function ___(__0, __2) { importedSetsCount += __2;
                  self.output.info(util.format($("%d record sets of %d imported"), importedSetsCount, totalSetsCount)); while (__more) { __loop(); }; __more = true; }, true)); } else { __break(); } ; }); do { __loop(); } while (__more); __more = true; })(function __$import__9() {


            if (options.debug) { console.timeEnd("Time elapsed"); } ; _(); }); }); }, true)); }); },


  export: function export__10(resourceGroupName, zoneName, options, _) { var self, dnsZone, recordSets, nextLink, nextRecordSets, fileData, progress, __this = this; var __frame = { name: "export__10", line: 244 }; return __func(_, this, arguments, export__10, 3, __frame, function __$export__10() { self = __this;
      ...
      zoneName = utils.trimTrailingChar(zoneName, "."); return (function __$export__10(__then) {
        ...
        if (fs.existsSync(options.fileName)) { return (function __$export__10(_) {
            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Overwrite file \"%s\"? [y/n] "), options.fileName), __cb(_, __frame, 6, 46, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -243, 17, function ___(__0, __2) { return (function __$export__10(__then) { if (__2) { return _(null); } else { __then(); } ; })(__then); }, true)); } else { __then(); } ; })(function __$export__10() {
        ...
        return self.get(resourceGroupName, zoneName, __cb(_, __frame, 11, 23, function ___(__0, __3) { dnsZone = __3;
          ...
          return self.dnsManagementClient.recordSets.listAllInResourceGroup(resourceGroupName, zoneName, options, __cb(_, __frame, 15, 57, function ___(__0, __4) { recordSets = __4;
            ...
            nextLink = recordSets.nextLink; return (function ___(__break) { var __more; var __loop = __cb(_, __frame, 0, 0, function __$export__10() { __more = false;
                var __9 = (nextLink !== undefined); if (__9) {
                  self.output.silly("Following nextLink");
                  return self.dnsManagementClient.recordSets.listAllInResourceGroupNext(nextLink, __cb(_, __frame, 20, 63, function ___(__0, __5) { nextRecordSets = __5;
  ...
  importRecordSet: function importRecordSet__11(resourceGroupName, zoneName, recordSet, options, _) { var self, parameters, progress, res, existingSet, __this = this; var __frame = { name: "importRecordSet__11", line: 282 }; return __func(_, this, arguments, importRecordSet__11, 4, __frame, function __$importRecordSet__11() { self = __this;
      ...
      return self.tryImportRecordSet(resourceGroupName, zoneName, recordSet.name, recordSet.type, parameters, __cb(_, __frame, 38, 19, function ___(__0, __1) { res = __1; return (function __$importRecordSet__11(__then) {
          if ((res.statusCode === 412)) {
            return self.getRecordSet(resourceGroupName, zoneName, recordSet.name, recordSet.type, __cb(_, __frame, 40, 29, function ___(__0, __2) { existingSet = __2;
              parameters = recordSetUtils.merge(parameters, existingSet, recordSet.type, options, self.output);
              return self.tryImportRecordSet(resourceGroupName, zoneName, recordSet.name, recordSet.type, parameters, __cb(_, __frame, 42, 11, __then, true)); }, true)); } else { __then(); } ; })(function __$importRecordSet__11() {
  ...
  tryImportRecordSet: function tryImportRecordSet__12(resourceGroupName, zoneName, setName, setType, parameters, _) { var self, res, __this = this; var __frame = { name: "tryImportRecordSet__12", line: 331 }; return __func(_, this, arguments, tryImportRecordSet__12, 5, __frame, function __$tryImportRecordSet__12() { self = __this;
  ...
  createRecordSet: function createRecordSet__13(resourceGroupName, zoneName, setName, options, _) { var self, recordSet, progress, __this = this; var __frame = { name: "createRecordSet__13", line: 354 }; return __func(_, this, arguments, createRecordSet__13, 4, __frame, function __$createRecordSet__13() { self = __this;
  ...
  setRecordSet: function setRecordSet__14(resourceGroupName, zoneName, setName, options, _) { var self, zone, recordSet, __this = this; var __frame = { name: "setRecordSet__14", line: 367 }; return __func(_, this, arguments, setRecordSet__14, 4, __frame, function __$setRecordSet__14() { self = __this;
      ...
      return self.get(resourceGroupName, zoneName, __cb(_, __frame, 4, 20, function ___(__0, __1) { zone = __1;
        ...
        return self.getRecordSet(resourceGroupName, zoneName, setName, options.type, __cb(_, __frame, 9, 25, function ___(__0, __2) { recordSet = __2;
          if (!recordSet) {
  ...
  setSoaRecord: function setSoaRecord__15(resourceGroupName, zoneName, options, _) { var self, setName, recordSet, __this = this; var __frame = { name: "setSoaRecord__15", line: 387 }; return __func(_, this, arguments, setSoaRecord__15, 3, __frame, function __$setSoaRecord__15() { self = __this;



      setName = "@";
      options.type = constants.dnsZone.SOA;
      return self.getRecordSet(resourceGroupName, zoneName, setName, options.type, __cb(_, __frame, 6, 25, function ___(__0, __1) { recordSet = __1;
        if (!recordSet) {
          return _(new Error(util.format($("A record set with name \"%s\" of type \"%s\" not found in the DNS zone \"%s\""), setName, options.type, zoneName))); } ;
  ...
  deleteRecordSet: function deleteRecordSet__16(resourceGroupName, zoneName, setName, options, _) { var self, recordSet, progress, __this = this; var __frame = { name: "deleteRecordSet__16", line: 421 }; return __func(_, this, arguments, deleteRecordSet__16, 4, __frame, function __$deleteRecordSet__16() { self = __this;


      return self.getRecordSet(resourceGroupName, zoneName, setName, options.type, __cb(_, __frame, 3, 25, function ___(__0, __2) { recordSet = __2;
        if (!recordSet) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete DNS record set \"%s\" from DNS zone \"%s\"? [y/n] "), setName, zoneName), __cb(_, __frame, 8, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -420, 17, function ___(__0, __3) { return (function __$deleteRecordSet__16(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteRecordSet__16() {
  ...
  listRecordSets: function listRecordSets__17(resourceGroupName, zoneName, options, _) { var self, dnsRecords, progress, nextLink, nextRecordSets, __this = this; var __frame = { name: "listRecordSets__17", line: 441 }; return __func(_, this, arguments, listRecordSets__17, 3, __frame, function __$listRecordSets__17() { self = __this;
  ...
  getRecordSet: function getRecordSet__18(resourceGroupName, zoneName, setName, setType, _) { var self, progress, recordSet, __this = this; var __frame = { name: "getRecordSet__18", line: 493 }; return __func(_, this, arguments, getRecordSet__18, 4, __frame, function __$getRecordSet__18() { self = __this;


      progress = self.interaction.progress(util.format($("Looking up the DNS Record Set \"%s\" of type \"%s\""), setName, setType)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getRecordSet__18() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getRecordSet__18() {

                  setType = setType.toUpperCase();
                  return self.dnsManagementClient.recordSets.get(resourceGroupName, zoneName, setName, setType, __cb(_, __frame, 6, 58, function ___(__0, __1) { recordSet = __1;
  ...
  showRecordSet: function showRecordSet__19(resourceGroupName, zoneName, setName, options, _) { var self, recordSet, __this = this; var __frame = { name: "showRecordSet__19", line: 512 }; return __func(_, this, arguments, showRecordSet__19, 4, __frame, function __$showRecordSet__19() { self = __this;
  ...
  addRecord: function addRecord__20(resourceGroupName, zoneName, setName, options, _) { var self, dnsZone, recordSet, __this = this; var __frame = { name: "addRecord__20", line: 526 }; return __func(_, this, arguments, addRecord__20, 4, __frame, function __$addRecord__20() { self = __this;
      ...
      return self.get(resourceGroupName, zoneName, __cb(_, __frame, 4, 23, function ___(__0, __2) { dnsZone = __2;
        ...
        return self.getRecordSet(resourceGroupName, zoneName, setName, options.type, __cb(_, __frame, 9, 25, function ___(__0, __3) { recordSet = __3; return (function __$addRecord__20(__then) {
            if (recordSet) { return (function __$addRecord__20(_) {
                var __1 = (options.type === constants.dnsZone.CNAME); if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($(("The DNS record set with type \"%s\" permits only one record per record set." + "Do you want to replace the existing record set value to new \"%s\"? [y/n]")), options.type, options.cname), __cb(_, __frame, 11, 72, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -525, 17, function ___(__0, __4) { return (function __$addRecord__20(__then) { if (__4) { return _(null); } else { __then(); } ; })(__then); }, true)); } else {
            ...
            return self.updateRecordSet(resourceGroupName, zoneName, setName, options.type, recordSet, __cb(_, __frame, 20, 21, function ___(__0, __5) { recordSet = __5;
              self._showRecordSet(recordSet); _(); }, true)); }); }, true)); }, true)); }); },


  deleteRecord: function deleteRecord__21(resourceGroupName, zoneName, setName, options, _) { var self, dnsZone, recordSet, __this = this; var __frame = { name: "deleteRecord__21", line: 550 }; return __func(_, this, arguments, deleteRecord__21, 4, __frame, function __$deleteRecord__21() { self = __this;
      ...
      return self.get(resourceGroupName, zoneName, __cb(_, __frame, 4, 23, function ___(__0, __2) { dnsZone = __2;
        ...
        return self.getRecordSet(resourceGroupName, zoneName, setName, options.type, __cb(_, __frame, 9, 25, function ___(__0, __3) { recordSet = __3;
          if (!recordSet) {
            return _(new Error(util.format($("A record set with name \"%s\" of type \"%s\" not found in DNS zone \"%s\""), setName, options.type, zoneName))); } ;


          self._parseRecord(recordSet, options, false); return (function __$deleteRecord__21(_) {

            var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm($("Delete DNS Record? [y/n] "), __cb(_, __frame, 16, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -549, 17, function ___(__0, __4) { return (function __$deleteRecord__21(__then) { if (__4) { return _(null); } else { __then(); } ; })(function __$deleteRecord__21() { return (function __$deleteRecord__21(__then) {
                ...
                if ((options.type === constants.dnsZone.CNAME)) {
                  ...
                  return self.deleteRecordSet(resourceGroupName, zoneName, setName, options, __cb(_, __frame, 24, 11, __then, true)); } else {

                  return self.updateRecordSet(resourceGroupName, zoneName, setName, options.type, recordSet, __cb(_, __frame, 26, 23, function ___(__0, __5) { recordSet = __5;
                    self._showRecordSet(recordSet); __then(); }, true)); } ; })(_); }); }, true)); }, true)); }, true)); }); },



  updateRecordSet: function updateRecordSet__22(resourceGroupName, zoneName, setName, setType, parameters, _) { var self, progress, recordSet, __this = this; var __frame = { name: "updateRecordSet__22", line: 581 }; return __func(_, this, arguments, updateRecordSet__22, 5, __frame, function __$updateRecordSet__22() { self = __this;
  ...
  promptRecordParamsIfNotGiven: function promptRecordParamsIfNotGiven__23(options, _) { var self, __this = this; var __frame = { name: "promptRecordParamsIfNotGiven__23", line: 597 }; return __func(_, this, arguments, promptRecordParamsIfNotGiven__23, 1, __frame, function __$promptRecordParamsIfNotGiven__23() { self = __this;
