...
__.extend(VMClient.prototype, {
              ...
              if (options.uninstall) {
                ...
                pubConfig["runlist"] = options.runList; return (function __$setChefExtension__28(__then) {
                  ...
                  if (options.jsonAttributes) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$setChefExtension__28() {
                    ...
                    return __this._createOrUpdateExtension(resourceGroupName, vmName, extensionName, CHEFPUBLISHER, options.version, options, serviceClients, __cb(_, __frame, 80, 9, function __$setChefExtension__28() { _(); }, true)); }); }); }); }); }, true)); }); }); }); },



  getExtensions: function getExtensions__29(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getExtensions__29", line: 1173 }; return __func(_, this, arguments, getExtensions__29, 3, __frame, function __$getExtensions__29() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  getChefExtension: function getChefExtension__30(resourceGroup, vmName, options, _) { var subscription, serviceClients, virtualMachine, vmResult, output, __this = this; var __frame = { name: "getChefExtension__30", line: 1204 }; return __func(_, this, arguments, getChefExtension__30, 3, __frame, function __$getChefExtension__30() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  createDockerVM: function createDockerVM__31(resourceGroupName, vmName, location, osType, options, _) { var subscription, serviceClients, dockerExtensionParams, vmExtensionProfile, dockerExtension, virtualMachine, __this = this; var __frame = { name: "createDockerVM__31", line: 1239 }; return __func(_, this, arguments, createDockerVM__31, 5, __frame, function __$createDockerVM__31() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImagePublishers: function listVMImagePublishers__32(location, options, _) { var subscription, serviceClients, vmImage, publishersResult, publishers, output, __this = this; var __frame = { name: "listVMImagePublishers__32", line: 1264 }; return __func(_, this, arguments, listVMImagePublishers__32, 2, __frame, function __$listVMImagePublishers__32() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageOffers: function listVMImageOffers__33(location, publisherName, options, _) { var subscription, serviceClients, vmImage, offersResult, offers, output, __this = this; var __frame = { name: "listVMImageOffers__33", line: 1291 }; return __func(_, this, arguments, listVMImageOffers__33, 3, __frame, function __$listVMImageOffers__33() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImageSkus: function listVMImageSkus__34(location, publisherName, offer, options, _) { var subscription, serviceClients, vmImage, skuResult, skus, output, __this = this; var __frame = { name: "listVMImageSkus__34", line: 1319 }; return __func(_, this, arguments, listVMImageSkus__34, 4, __frame, function __$listVMImageSkus__34() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMImages: function listVMImages__35(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "listVMImages__35", line: 1348 }; return __func(_, this, arguments, listVMImages__35, 2, __frame, function __$listVMImages__35() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
  ...
  getVMImageDetails: function getVMImageDetails__36(params, options, _) { var subscription, serviceClients, imageFilter, vmImage, imagesResult, images, output, __this = this; var __frame = { name: "getVMImageDetails__36", line: 1385 }; return __func(_, this, arguments, getVMImageDetails__36, 2, __frame, function __$getVMImageDetails__36() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      imageFilter = {
        location: params.location,
  ...
  listVMExtensionImageTypes: function listVMExtensionImageTypes__37(location, publisherName, options, _) { var subscription, serviceClients, vmImage, typesResult, types, output, __this = this; var __frame = { name: "listVMExtensionImageTypes__37", line: 1426 }; return __func(_, this, arguments, listVMExtensionImageTypes__37, 3, __frame, function __$listVMExtensionImageTypes__37() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  listVMExtensionImageVersions: function listVMExtensionImageVersions__38(location, publisherName, typeName, options, _) { var subscription, serviceClients, vmImage, versionsResult, versions, output, __this = this; var __frame = { name: "listVMExtensionImageVersions__38", line: 1454 }; return __func(_, this, arguments, listVMExtensionImageVersions__38, 4, __frame, function __$listVMExtensionImageVersions__38() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
  ...
  _createOrUpdateExtension: function _createOrUpdateExtension__41(resourceGroupName, vmName, extensionName, publisherName, version, options, serviceClients, _) { var vMExtensionProfile, vmExtension, virtualMachine, __this = this; var __frame = { name: "_createOrUpdateExtension__41", line: 1533 }; return __func(_, this, arguments, _createOrUpdateExtension__41, 7, __frame, function __$_createOrUpdateExtension__41() {
  ...
  _uninstallExtension: function _uninstallExtension__42(resourceGroupName, vmName, extensionName, serviceClients, options, _) { var virtualMachine, extension, __this = this; var __frame = { name: "_uninstallExtension__42", line: 1545 }; return __func(_, this, arguments, _uninstallExtension__42, 5, __frame, function __$_uninstallExtension__42() {
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVMExtension(resourceGroupName, vmName, extensionName, __cb(_, __frame, 2, 35, function ___(__0, __2) { extension = __2;
        if (!extension) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return __this.cli.interaction.confirm(util.format($("Uninstall the virtual machine extension \"%s\"? [y/n] "), extensionName), __cb(_, __frame, 7, 48, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -1544, 17, function ___(__0, __3) { return (function __$_uninstallExtension__42(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$_uninstallExtension__42() {
  ...
  addSecret: function addSecret__49(params, options, _) { var subscription, serviceClients, virtualMachine, vmResult, sourceVaultObj, certUrlObj, __this = this; var __frame = { name: "addSecret__49", line: 2176 }; return __func(_, this, arguments, addSecret__49, 2, __frame, function __$addSecret__49() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  deleteSecret: function deleteSecret__50(params, options, _) { var subscription, serviceClients, virtualMachine, vmResult, i0, i, j, __this = this; var __frame = { name: "deleteSecret__50", line: 2201 }; return __func(_, this, arguments, deleteSecret__50, 2, __frame, function __$deleteSecret__50() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVM(params.group, params.name, __cb(_, __frame, 4, 34, function ___(__0, __1) { vmResult = __1;
