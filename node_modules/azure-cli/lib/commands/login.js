...
exports.init = function(cli) {
        ...
        if (!tokenCache.isSecureCache) {
          haveSeenBefore = __.values(profile.current.subscriptions).some(function(s) {
            ...
            if ((!options.quiet && !haveSeenBefore)) {
              return cli.interaction.confirm(util.format(piiWarningText, profile.defaultProfileFile), __cb(_, __frame, 26, 31, function ___(__0, __2) { var __1 = !__2; return (function __$__1(__then) { if (__1) {
          ...
          if (options.servicePrincipal) {
            ...
            return cli.interaction.promptIfNotGiven("Tenant: ", options.tenant, __cb(_, __frame, 47, 33, function ___(__0, __3) { tenant = __3; __then(); }, true)); } else { __then(); } ; })(function __$__1() { return (function __$__1(__then) {

            if ((options.username && requirePassword)) {
              return cli.interaction.promptPasswordOnceIfNotGiven("Password: ", options.password, __cb(_, __frame, 50, 35, function ___(__0, __4) { password = __4; __then(); }, true)); } else { __then(); } ; })(function __$__1() {
            ...
            progress = cli.interaction.progress($("Authenticating...")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function __$__1(__then) {
                          ...
                          if (!interactive) {
                            return adalAuth.removeCachedToken(options.username, __cb(_, __frame, 56, 19, __then, true)); } else { __then(); } ; })(function __$__1() {
                          ...
                          account = new Account(environment, authObject, resourceClient, log); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                                ...
                                return account.load(options.username, password, tenant, loginType, __cb(_, __frame, 66, 27, function ___(__0, __5) { result = __5; __then(); }, true)); }); })(function ___(ex, __result) { __catch(function __$__1() { if (ex) {
  ...
  cli.command("logout [username]").description($("Log out from Azure subscription using Active Directory. Currently, the user can log out only via Microsoft organizational account")).option("-u --username <username>", $("Required. User name used to log out from Azure Active Directory.")).execute(function __2(username, options, _) { var __frame = { name: "__2", line: 166 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
