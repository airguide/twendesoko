...
exports.init = function(cli) {
  ...
  applicationType.command("register [applicationTypeBuildPath]").description($("Register application type, Example: azure servicefabric application type register --application-type-build-path Package1")).option("-p --application-type-build-path <applicationTypeBuildPath>", $("the path of the application type build")).execute(function __6(applicationTypeBuildPath, options, _) { var progress, config, client, registerApplicationType, res; var __frame = { name: "__6", line: 191 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
        ...
        progress = cli.interaction.progress($("Register application type")); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
              ...
              return serviceFabricUtils.readServiceFabricConfig(progress, __cb(_, __frame, 6, 40, function ___(__0, __2) { config = __2;
                ...
                return serviceFabricUtils.createConnectionUrl(config, __cb(_, __frame, 8, 79, function ___(__0, __3) { return serviceFabricUtils.getClientOptions(config, __cb(_, __frame, 8, 130, function ___(__0, __4) { client = new serviceFabricClient("3.0-preview", __3, __4);
                    ...
                    return client.applicationTypes.register(registerApplicationType, options, __cb(_, __frame, 11, 42, function ___(__0, __5) { res = __5;
  ...
  applicationHealth.command("send [applicationName] [sourceId] [property] [healthState]").description($("Send application health, Example: azure servicefabric application health send --application-name fabric:app --source-id monitor --property pc --health-state Ok --description healthy")).option("-n --application-name <applicationName>", $("the name of the application")).option("-i --source-id <sourceId>", $("the id of the source")).option("-p --property <property>", $("the property")).option("-e --health-state <healthState>", $("the state of the health, values are [Ok|Warning|Error|Unknown]")).option("-d --description <description>", $("the description")).option("-m --time-to-live-in-milliSeconds <timeToLiveInMilliSeconds>", $("the time in milliseconds for live")).option("-q --sequence-number <sequenceNumber>", $("the number of the sequence")).option("-w --remove-when-expired", $("the boolean of the remove when expired")).option("--select <fields>", $("select fields to show, call without this parameter to see all fields")).execute(function __9(applicationName, sourceId, property, healthState, options, _) { var progress, config, client, applicationHealthReport, res; var __frame = { name: "__9", line: 289 }; return __func(_, this, arguments, __9, 5, __frame, function __$__9() {
  ...
  applicationUpgrade.command("rollback [applicationName]").description($("Start application upgrade rollback")).option("-n --application-name <applicationName>", $("the name of the application")).execute(function __17(applicationName, options, _) { var progress, config, client, res; var __frame = { name: "__17", line: 618 }; return __func(_, this, arguments, __17, 2, __frame, function __$__17() {
