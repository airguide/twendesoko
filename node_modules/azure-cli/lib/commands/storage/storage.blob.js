...
exports.init = function(cli) {
  ...
  function listAzureContainersWithAcl(prefix, options, _) { var blobService, listOperation, tips, containerOpts, useWildcard, containers, supportACL; var __frame = { name: "listAzureContainersWithAcl", line: 471 }; return __func(_, this, arguments, listAzureContainersWithAcl, 2, __frame, function __$listAzureContainersWithAcl() {
      ...
      startProgress(tips); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$listAzureContainersWithAcl() {
            ...
            supportACL = true;
            return performStorageOperation(listOperation, __cb(_, __frame, 21, 6, function ___(__0, __2) { return __2.forEach_(__cb(_, __frame, 21, 63, function __$listAzureContainersWithAcl() { _(null, null, true); }, true), 1, function __1(_, container) { var aclOperation, aclOptions, permission, level; var __frame = { name: "__1", line: 492 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
  ...
  function showAzureContainer(container, options, _) { var blobService, propertiesOperation, tips, showOptions, aclOperation, properties, permission, level; var __frame = { name: "showAzureContainer", line: 533 }; return __func(_, this, arguments, showAzureContainer, 2, __frame, function __$showAzureContainer() {
      blobService = getBlobServiceClient(options);
  ...
  function createAzureContainer(container, options, _) { var blobService, operation, tips, storageOptions, permission, createResult, aclOperation; var __frame = { name: "createAzureContainer", line: 572 }; return __func(_, this, arguments, createAzureContainer, 2, __frame, function __$createAzureContainer() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 28, function ___(__0, __1) { container = __1;
  ...
  function deleteAzureContainer(container, options, _) { var blobService, tips, operation, storageOptions, force; var __frame = { name: "deleteAzureContainer", line: 609 }; return __func(_, this, arguments, deleteAzureContainer, 2, __frame, function __$deleteAzureContainer() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 28, function ___(__0, __1) { container = __1;
  ...
  function setAzureContainer(container, options, _) { var blobService, tips; var __frame = { name: "setAzureContainer", line: 645 }; return __func(_, this, arguments, setAzureContainer, 2, __frame, function __$setAzureContainer() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 28, function ___(__0, __1) { container = __1;
        tips = $("Set container");
  ...
  function setAzureContainerAcl(blobService, container, options, _) { var getAclOperation, setAclOperation, storageOptions, policies; var __frame = { name: "setAzureContainerAcl", line: 660 }; return __func(_, this, arguments, setAzureContainerAcl, 3, __frame, function __$setAzureContainerAcl() { return (function __$setAzureContainerAcl(__then) {
  ...
  function acquireContainerLease(container, duration, proposedId, options, _) { var __frame = { name: "acquireContainerLease", line: 683 }; return __func(_, this, arguments, acquireContainerLease, 4, __frame, function __$acquireContainerLease() {
  ...
  function acquireBlobLease(container, blob, duration, proposedId, options, _) { var __frame = { name: "acquireBlobLease", line: 691 }; return __func(_, this, arguments, acquireBlobLease, 5, __frame, function __$acquireBlobLease() {
  ...
  function acquireLease(container, blob, duration, proposedId, options, _) { var blobService; var __frame = { name: "acquireLease", line: 700 }; return __func(_, this, arguments, acquireLease, 5, __frame, function __$acquireLease() {
      blobService = getBlobServiceClient(options);
  ...
  function renewContainerLease(container, leaseId, options, _) { var __frame = { name: "renewContainerLease", line: 716 }; return __func(_, this, arguments, renewContainerLease, 3, __frame, function __$renewContainerLease() {
  ...
  function renewBlobLease(container, blob, leaseId, options, _) { var __frame = { name: "renewBlobLease", line: 724 }; return __func(_, this, arguments, renewBlobLease, 4, __frame, function __$renewBlobLease() {
      options.forBlob = true;
  ...
  function renewLease(container, blob, leaseId, options, _) { var blobService; var __frame = { name: "renewLease", line: 733 }; return __func(_, this, arguments, renewLease, 4, __frame, function __$renewLease() {
      blobService = getBlobServiceClient(options);
      __.extend(options, getStorageBlobOperationDefaultOption());
  ...
  function changeContainerLease(container, leaseId, proposedId, options, _) { var __frame = { name: "changeContainerLease", line: 748 }; return __func(_, this, arguments, changeContainerLease, 4, __frame, function __$changeContainerLease() {
  ...
  function changeBlobLease(container, blob, leaseId, proposedId, options, _) { var __frame = { name: "changeBlobLease", line: 756 }; return __func(_, this, arguments, changeBlobLease, 5, __frame, function __$changeBlobLease() {
      options.forBlob = true;
  ...
  function changeLease(container, blob, leaseId, proposedId, options, _) { var blobService; var __frame = { name: "changeLease", line: 765 }; return __func(_, this, arguments, changeLease, 5, __frame, function __$changeLease() {
      blobService = getBlobServiceClient(options);
      __.extend(options, getStorageBlobOperationDefaultOption());
  ...
  function releaseContainerLease(container, leaseId, options, _) { var __frame = { name: "releaseContainerLease", line: 781 }; return __func(_, this, arguments, releaseContainerLease, 3, __frame, function __$releaseContainerLease() {
  ...
  function releaseBlobLease(container, blob, leaseId, options, _) { var __frame = { name: "releaseBlobLease", line: 789 }; return __func(_, this, arguments, releaseBlobLease, 4, __frame, function __$releaseBlobLease() {
      options.forBlob = true;
  ...
  function releaseLease(container, blob, leaseId, options, _) { var blobService; var __frame = { name: "releaseLease", line: 798 }; return __func(_, this, arguments, releaseLease, 4, __frame, function __$releaseLease() {
      blobService = getBlobServiceClient(options);
      __.extend(options, getStorageBlobOperationDefaultOption());
  ...
  function breakContainerLease(container, duration, options, _) { var __frame = { name: "breakContainerLease", line: 813 }; return __func(_, this, arguments, breakContainerLease, 3, __frame, function __$breakContainerLease() {
  ...
  function breakBlobLease(container, blob, duration, options, _) { var __frame = { name: "breakBlobLease", line: 821 }; return __func(_, this, arguments, breakBlobLease, 4, __frame, function __$breakBlobLease() {
      options.forBlob = true;
  ...
  function breakLease(container, blob, duration, options, _) { var blobService; var __frame = { name: "breakLease", line: 830 }; return __func(_, this, arguments, breakLease, 4, __frame, function __$breakLease() {
      blobService = getBlobServiceClient(options);
      __.extend(options, getStorageBlobOperationDefaultOption());
  ...
  function createContainerSAS(container, permissions, expiry, options, _) { var __frame = { name: "createContainerSAS", line: 845 }; return __func(_, this, arguments, createContainerSAS, 4, __frame, function __$createContainerSAS() {
  ...
  function createBlobSAS(container, blob, permissions, expiry, options, _) { var __frame = { name: "createBlobSAS", line: 852 }; return __func(_, this, arguments, createBlobSAS, 5, __frame, function __$createBlobSAS() {
  ...
  function createSas(container, blob, permissions, protocol, ipRange, expiry, options, isOnContainer, _) { var blobService, accessType, start, output, sharedAccessPolicy, tips; var __frame = { name: "createSas", line: 859 }; return __func(_, this, arguments, createSas, 8, __frame, function __$createSas() {
      blobService = getBlobServiceClient(options);
  ...
  function createContainerPolicy(container, name, options, _) { var createPolicySettings, policies; var __frame = { name: "createContainerPolicy", line: 909 }; return __func(_, this, arguments, createContainerPolicy, 3, __frame, function __$createContainerPolicy() {
  ...
  function listContainerPolicy(container, options, _) { var listPolicySettings, policies; var __frame = { name: "listContainerPolicy", line: 929 }; return __func(_, this, arguments, listContainerPolicy, 2, __frame, function __$listContainerPolicy() {
  ...
  function showContainerPolicy(container, name, options, _) { var showPolicySettings, policy; var __frame = { name: "showContainerPolicy", line: 947 }; return __func(_, this, arguments, showContainerPolicy, 3, __frame, function __$showContainerPolicy() {
  ...
  function setContainerPolicy(container, name, options, _) { var setPolicySettings, policies; var __frame = { name: "setContainerPolicy", line: 962 }; return __func(_, this, arguments, setContainerPolicy, 3, __frame, function __$setContainerPolicy() {
  ...
  function deleteContainerPolicy(container, name, options, _) { var deletePolicySettings, policies; var __frame = { name: "deleteContainerPolicy", line: 982 }; return __func(_, this, arguments, deleteContainerPolicy, 3, __frame, function __$deleteContainerPolicy() {
  ...
  function listAzureBlob(container, blobName, options, _) { var blobService, specifiedContainerName, tips, operation, storageOptions, useWildcard, inputBlobName, blobs, outputBlobs, i, len, blob; var __frame = { name: "listAzureBlob", line: 1002 }; return __func(_, this, arguments, listAzureBlob, 3, __frame, function __$listAzureBlob() {
      blobService = getBlobServiceClient(options);
  ...
  function showAzureBlob(containerName, blobName, options, _) { var blob; var __frame = { name: "showAzureBlob", line: 1061 }; return __func(_, this, arguments, showAzureBlob, 3, __frame, function __$showAzureBlob() {
  ...
  function deleteAzureBlob(container, blobName, options, _) { var blobService, specifiedContainerName, specifiedBlobName, storageOptions, force, message, tips, operation; var __frame = { name: "deleteAzureBlob", line: 1121 }; return __func(_, this, arguments, deleteAzureBlob, 3, __frame, function __$deleteAzureBlob() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 45, function ___(__0, __1) { specifiedContainerName = __1;
        return interaction.promptIfNotGiven($("Blob name: "), blobName, __cb(_, __frame, 3, 40, function ___(__0, __2) { specifiedBlobName = __2;
          storageOptions = getStorageBlobOperationDefaultOption();
  ...
  function updateAzureBlob(container, blobName, options, _) { var blobService, specifiedContainerName, specifiedBlobName, specifiedProperties, storageOptions, tips, existingBlobProperties, properties, propertiesOperation; var __frame = { name: "updateAzureBlob", line: 1181 }; return __func(_, this, arguments, updateAzureBlob, 3, __frame, function __$updateAzureBlob() {
      blobService = getBlobServiceClient(options);
  ...
  function uploadAzureBlob(file, container, blobName, options, _) { var blobService, specifiedContainerName, specifiedFileName, specifiedBlobName, storageOptions, properties, force, summary, fsStatus, defaultBlobTypeName, blobTypeName, specifiedBlobType, sizeLimit, tips, blobProperties, propertiesOperation, operation, printer, intervalId, extendOption; var __frame = { name: "uploadAzureBlob", line: 1237 }; return __func(_, this, arguments, uploadAzureBlob, 4, __frame, function __$uploadAzureBlob() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 45, function ___(__0, __1) { specifiedContainerName = __1;
          ...
          force = options.quiet; return (function __$downloadAzureBlob(__then) {
            ...
            return utils.fileExists(dirName, __cb(_, __frame, 28, 15, function ___(__0, __6) { var __5 = !__6; return (function __$downloadAzureBlob(__then) { if (__5) {
                ...
                fullName = path.join(dirName, fileName); return (function __$downloadAzureBlob(_) {
                  var __1 = (force !== true); if (!__1) { return _(null, __1); } ; return utils.fileExists(fullName, __cb(_, __frame, 50, 32, _, true)); })(__cb(_, __frame, -1350, 18, function ___(__0, __7) { return (function __$downloadAzureBlob(__then) { if (__7) {
  ...
  function snapshotAzureBlob(container, blobName, options, _) { var blobService, snapshotOperation, snapshotOptions, snapshotTime, tips, result; var __frame = { name: "snapshotAzureBlob", line: 1478 }; return __func(_, this, arguments, snapshotAzureBlob, 3, __frame, function __$snapshotAzureBlob() {
      blobService = getBlobServiceClient(options);
      return interaction.promptIfNotGiven($("Container name: "), container, __cb(_, __frame, 2, 28, function ___(__0, __1) { container = __1;
  ...
  function startBlobCopy(sourceUri, destContainer, options, _) { var startCopyParams; var __frame = { name: "startBlobCopy", line: 1538 }; return __func(_, this, arguments, startBlobCopy, 3, __frame, function __$startBlobCopy() {
  ...
  function showBlobCopy(container, blob, options, _) { var showCopyParams; var __frame = { name: "showBlobCopy", line: 1546 }; return __func(_, this, arguments, showBlobCopy, 3, __frame, function __$showBlobCopy() {
      showCopyParams = {
  ...
  function stopBlobCopy(container, blob, copyid, options, _) { var getStopOperation, stopCopyParams; var __frame = { name: "stopBlobCopy", line: 1558 }; return __func(_, this, arguments, stopBlobCopy, 4, __frame, function __$stopBlobCopy() {
